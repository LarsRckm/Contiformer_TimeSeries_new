...
def generate_noisy_data_periodic_sum(x_values, vocab_size, noise_std):
    ...
    y_trend = vertical_scaling * np.sin(3*(x_values+horizontal_setoff)/horizontal_scaling) + vertical_setoff
    ...
    for i in range(randint(5,10)):
        ...
        y_trend += vertical_scaling * np.sin(2*(x_values+horizontal_setoff)/horizontal_scaling) + vertical_setoff
